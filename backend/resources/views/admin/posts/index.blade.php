                    ...
                    <form class="tablelist-form" method="post" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="customername-field"
                                    class="form-control" placeholder="Enter post short_description"
                                    name="short_description" required  value="{{ old('short_description') }}"/>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" id="customername-field" rows="5"
                                    class="form-control summernote" placeholder="Enter post description"
                                        ...
                                        <form class="tablelist-form" method="post" action="{{ route('admin.posts.update',$post->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="customername-field"
                                                        class="form-label">Short Description</label>
                                                    <input type="text" id="customername-fields"
                                                        class="form-control"
                                                        name="short_description" required  value="{{ $post->short_description }}"/>
